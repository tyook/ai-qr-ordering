...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium transition-colors hover:bg-secondary focus:outline-none focus:ring-1 focus:ring-ring disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-white/40 group-[.destructive]:hover:bg-white/20 group-[.destructive]:text-white group-[.success]:border-white/40 group-[.success]:hover:bg-white/20 group-[.success]:text-white group-[.info]:border-white/40 group-[.info]:hover:bg-white/20 group-[.info]:text-white",
      className
    )}
    {...props}
  />
